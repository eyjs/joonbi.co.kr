...
export function PortfolioForm({ portfolio, mode }: PortfolioFormProps): JSX.Element {
  ...
  const [form, setForm] = useState<FormData>({
    ...
    priceRange: portfolio?.priceRange || '',
  });
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="title" className={LABEL_CLASS}>제목</label>
              <input
                id="title"
                name="title"
                type="text"
            ...
            <div>
              <label htmlFor="slug" className={LABEL_CLASS}>Slug (URL 경로)</label>
              <input
                id="slug"
                name="slug"
                type="text"
          ...
          <div>
            <label htmlFor="description" className={LABEL_CLASS}>설명</label>
            <textarea
              id="description"
              name="description"
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <ImageUploader
                ...
                onUpload={(url) => setForm((prev) => ({ ...prev, thumbnailUrl: url }))}
              />
            </div>
            <div>
              <label htmlFor="thumbnailUrl" className={LABEL_CLASS}>썸네일 URL (직접 입력)</label>
              <input
                id="thumbnailUrl"
                name="thumbnailUrl"
                type="url"
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div>
              <label htmlFor="displayType" className={LABEL_CLASS}>공개 유형</label>
              <select
                id="displayType"
                name="displayType"
            ...
            <div>
              <label htmlFor="category" className={LABEL_CLASS}>카테고리</label>
              <input
                id="category"
                name="category"
                type="text"
            ...
            <div>
              <label htmlFor="completedAt" className={LABEL_CLASS}>완료일</label>
              <input
                id="completedAt"
                name="completedAt"
                type="date"
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="techStack" className={LABEL_CLASS}>기술 스택 (쉼표로 구분)</label>
              <input
                id="techStack"
                name="techStack"
                type="text"
            ...
            <div>
              <label htmlFor="clientName" className={LABEL_CLASS}>클라이언트명</label>
              <input
                id="clientName"
                name="clientName"
                type="text"
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 space-y-4">
          <h2 className="text-lg font-bold text-white mb-4">프로젝트 개요 카드</h2>

          <div>
            <label htmlFor="summary" className={LABEL_CLASS}>한줄 요약</label>
            <textarea
              id="summary"
              name="summary"
              value={form.summary}
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div>
              <label htmlFor="duration" className={LABEL_CLASS}>프로젝트 기간</label>
              <input
                id="duration"
                name="duration"
                type="text"
            ...
            <div>
              <label htmlFor="priceRange" className={LABEL_CLASS}>가격 범위</label>
              <input
                id="priceRange"
                name="priceRange"
                type="text"
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-white">Before / After</h2>
          </div>

          {/* Before items */}
          <div>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-sm font-semibold text-gray-300">Before (기존 문제)</h3>
              <button
                type="button"
            ...
            {beforeItems.length === 0 ? (
              <p className="text-gray-500 text-sm py-2">항목이 없습니다.</p>
            ) : (
                ...
                {beforeItems.map((item, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <input
                      ...
                      className="w-12 px-2 py-1.5 border border-gray-600 bg-gray-700 rounded-lg text-sm text-white text-center focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="X"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-sm font-semibold text-gray-300">After (개선 결과)</h3>
              <button
                type="button"
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-white">타임라인</h2>
            <button
              type="button"
          ...
          {milestones.length === 0 ? (
            <p className="text-gray-500 text-sm py-2">마일스톤이 없습니다.</p>
          ) : (
            <div className="space-y-2">
              {milestones.map((item, index) => (
                <div key={index} className="flex items-center gap-2">
                  <input
                    ...
                    className="w-32 px-2 py-1.5 border border-gray-600 bg-gray-700 rounded-lg text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  <select
                    ...
                    className="w-24 px-2 py-1.5 border border-gray-600 bg-gray-700 rounded-lg text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition-colors text-sm font-medium disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
        ...
        <div className="mt-8">
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-white">콘텐츠 섹션</h2>
                ...
                {(Object.keys(SECTION_TYPE_LABELS) as PortfolioSectionType[]).map(
                  (type) => (
                    <button
                      ...
                      className="text-xs px-3 py-1.5 border border-gray-600 rounded-lg hover:bg-gray-700 transition-colors text-gray-300"
                    >
